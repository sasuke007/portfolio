...
import { createVlogSchema } from "@/types/vlog/index";
import { z } from "zod";
...
export default function CreateVlogPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send POST request to create the vlog
      const response = await fetch("/api/admin/vlog", {
        method: "POST",
        headers: {
      ...
      toast.error("Failed to create vlog. Please try again.");
    } finally {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-bold">Create New Vlog</h1>
        </div>
